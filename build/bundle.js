var app = (function () {
    ...
    // (54:8) {#each materials as material (material.id)}
    function create_each_block(key_1, ctx) {
    	...
    	let t1;
    	let td1;
    	let t2_value = /*formatter*/ ctx[4].format(/*material*/ ctx[6].price) + "";
    	let t2;
    	let t3;
    	let td2;
    	let i;
    	...
    	return {
    		...
    		c() {
    			...
    			attr(tr, "class", "item svelte-c9azt3");
    			this.first = tr;
    		},
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(i, "click", stop_propagation(function () {
    						if (is_function(/*remove*/ ctx[3](/*material*/ ctx[6].id))) /*remove*/ ctx[3](/*material*/ ctx[6].id).apply(this, arguments);
    					})),
    		...
    		p(new_ctx, dirty) {
    			...
    			if (dirty & /*materials*/ 1 && t2_value !== (t2_value = /*formatter*/ ctx[4].format(/*material*/ ctx[6].price) + "")) set_data(t2, t2_value);
    		},
    		d(detaching) {
    ...
    function create_fragment$2(ctx) {
    	...
    	let t7;
    	let td1;
    	let t8_value = /*formatter*/ ctx[4].format(/*total*/ ctx[1]) + "";
    	let t8;
    	...
    	return {
            ...
            <th></th></tr>`;
    			...
    			td1 = element("td");
    			t8 = text(t8_value);
    			attr(td0, "class", "svelte-c9azt3");
    			attr(td1, "colspan", "2");
    			attr(td1, "class", "svelte-c9azt3");
    			attr(tr1, "class", "total svelte-c9azt3");
    			attr(table, "class", "primary svelte-c9azt3");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*total*/ 2 && t8_value !== (t8_value = /*formatter*/ ctx[4].format(/*total*/ ctx[1]) + "")) set_data(t8, t8_value);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [materials, total, edit, remove, formatter];
    }
    ...
    /* src\Form.svelte generated by Svelte v3.48.0 */
